...
function run() {
    ...
    for (let j = 0; j < scrambles.length / 5; j++) {
        ...
        for (let s of nScrambles) {
            ...
            let scram = "x' " + inverseAlg(ns.join(" ")) + " z' x'";"x z " +  + " x";
