...
const numOfLetters4BLD = 50;
const numOfLetters5BLD = 80;
let first = false;
let start = 0;
let interval = null;
let time = "00.00";
...
function getOptions() {
    ...
    const options = "<label for='selectEdgeBuffer'>Edge buffer&nbsp<select id='selectEdgeBuffer' onchange='setEdgeBuffer(this.value)'><option value='UF'>UF</option><option value='DF'>DF</option></select>&nbsp</label>"+
                    ...
                    "<label for='selectCubeType'>Event&nbsp<select id='selectCubeType' onchange='setCubeType(this.value)'><option value='3BLD'>3BLD</option><option value='4BLD' disabled>4BLD (Not finished)</option><option value='5BLD' disabled>5BLD (Not finished)</option><option>MBLD</option></select>&nbsp</label>"+
