class CubePlayer extends HTMLElement {
    connectedCallback() {
        ...
        scriptThreeJsMin.setAttribute('src','https://threejs.org/build/three.js');
        scriptThreeJsMin.setAttribute('integrity','sha512-dLxUelApnYxpLt6K2iomGngnHO83iUvZytA3YjDUCjT0HDOHKXnVYdf3hU4JjM8uEhxf9nD1/ey98U3t2vZ0qQ==');
        scriptThreeJsMin.setAttribute('crossorigin','anonymous');
        scriptThreeJsMin.setAttribute('referrerpolicy','no-referrer');
        ...
        function adjustSize() {
            ...
            $("#cubePlayer").css("-ms-transform", "translateX(-50%)");
            $("#cubePlayer").css("transform", "translateX(-50%)");
