...
function checkState() {
    let isSolved = false;
    let u = planes.filter(cu => {return cu.getWorldPosition(new THREE.Vector3()).y > 1.5});console.log(u);

    if ((u[0] === u[1] && u[0] === u[2] && u[0] === u[3] && u[0] === u[4] && u[0] === u[5] && u[0] === u[6] && u[0] === u[7] && u[0] === u[8]) &&
