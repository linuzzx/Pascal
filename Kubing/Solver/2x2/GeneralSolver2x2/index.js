...
let start;
$(() => {
    drawScrambleNxN('#svgCube', 2, $("#inpScramble").val());
...
function getSolution(solution) {
    if (solution[0] === 1) {
        ...
        ///////////////////////////////////////////////////////////////////
        drawScrambleNxN("#svgCube", 2, $("#inpScramble").val() + " " + sol);
    }
...
function solve(scramble, callback, endState = "wwwwooooggggrrrrbbbbyyyy") {
